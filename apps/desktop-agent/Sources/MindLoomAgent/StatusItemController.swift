...
final class StatusItemController: NSObject {
    ...
    private func finish(analyze: Bool) async {
        do {
            ...
            presentAlert(
                ...
                message: analyze
                    ? "Task summaries were uploaded and a Skill File draft was created. Review it in Workflows."
    ...
    @objc private func addFrontmost() {
        guard let app = NSWorkspace.shared.frontmostApplication,
            ...
            presentAlert(title: "No frontmost app", message: "Could not determine the active application.")
            return
        }
